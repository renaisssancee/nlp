...
### ДЗ1: Проектирование системы

Выдано: 09.03.2026 | Дедлайн: 23.03.2026

**Артефакты:**
- `README.md` — описание проекта, архитектура, стек, инструкция по запуску
- `design_doc.md` — детальный дизайн-документ с обоснованием всех решений
- `reports/hw1_report.md` — отчёт по этапу
